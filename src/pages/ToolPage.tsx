...
const toolMap: Record<string, { icon: React.ElementType; label: string; inputLabel: string; inputFormat: string; desc: string; seoTitle: string; seoDesc: string }> = {
  "pdf-to-word": {
    icon: FileText, label: "PDF to Word Converter", inputLabel: "PDF", inputFormat: "PDF", desc: "Convert your PDF documents into editable Word files",
  ...
  "word-to-pdf": {
    icon: FileDown, label: "Word to PDF Converter", inputLabel: "Word", inputFormat: "DOCX", desc: "Export your Word documents into professional PDF files",
  ...
  "pdf-merge": {
    icon: GitMerge, label: "PDF Merge", inputLabel: "PDF files", inputFormat: "PDF", desc: "Combine multiple PDF files into one seamless document",
  ...
  "pdf-split": {
    icon: Scissors, label: "PDF Split", inputLabel: "PDF", inputFormat: "PDF", desc: "Extract specific pages from your PDF document",
  ...
  "pdf-compress": {
    icon: Minimize2, label: "PDF Compress", inputLabel: "PDF", inputFormat: "PDF", desc: "Reduce the size of your PDF without losing quality",
  ...
  "image-to-pdf": {
    icon: Image, label: "Image to PDF", inputLabel: "Image", inputFormat: "JPG/PNG", desc: "Convert images into a PDF file seamlessly",
  ...
  "pdf-to-image": {
    icon: Download, label: "PDF to Image", inputLabel: "PDF", inputFormat: "PDF", desc: "Save PDF pages as high-quality images",
  ...
  "password-protect": {
    icon: Lock, label: "Password Protect PDF", inputLabel: "PDF", inputFormat: "PDF", desc: "Add a password to secure your PDF document",
  ...
  "unlock-pdf": {
    icon: Unlock, label: "Unlock PDF", inputLabel: "PDF", inputFormat: "PDF", desc: "Remove password restrictions from PDF files",
  ...
  "excel-to-pdf": {
    icon: Table, label: "Excel to PDF", inputLabel: "Excel", inputFormat: "XLSX/XLS", desc: "Convert spreadsheets into professional PDF documents",
  ...
  "powerpoint-to-pdf": {
    icon: Monitor, label: "PowerPoint to PDF", inputLabel: "PowerPoint", inputFormat: "PPTX/PPT", desc: "Save your slides into PDF format with ease",
        ...
        >
          ...
          {file ? (
            <div className="text-center">
              ...
              <button
                className="btn-gradient mt-4 px-8 py-3 rounded-full font-bold text-sm shadow-soft"
                onClick={(e) => { e.stopPropagation(); alert("Processing..."); }}
              >
                Convert Now
              </button>
            </div>
